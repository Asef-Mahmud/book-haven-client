...
const BookOfWeek = () => {
    return (
            <div className="hero bg-base-100 px-5 lg:px-10 font">
                <div className="hero-content flex-col lg:flex-row-reverse gap-5 lg:gap-10" data-aos="fade-bottom">
                    <img
                    src={weekBook}
                    ...
                    <p className="py-6 text-primary text-justify">
                    ...
                    <Link to='/all-books'><button className="btn btn-primary text-base-100 font-bold rounded-4xl">Get Started</button></Link>
                    </div>
                </div>
            </div>
    );
