...
const About = () => {
    ...
    return (
        <div className="font bg-accent-content py-10 lg:py-20">
            <div data-aos="fade-up" data-aos-easing="ease-in-out" className="max-w-11/12 mx-auto px-8 lg:px-30 text-primary">
                <h1 data-aos="fade-up" className="text-4xl text-center font-bold text-accent pt-10 my-3">
                        About Book Haven
                    </h1>
                <div data-aos="fade-right" className='md:border-l-4 md:border-l-accent md:px-5'>    
                    <p data-aos="fade-left" className="text-justify text-accent py-5 lg:py-10">Welcome to The Book Haven — your cozy corner of the digital world where stories come alive. Built for readers, dreamers, and collectors alike, The Book Haven is more than just a library — it's a sanctuary for every page you've ever loved. Here, you can explore timeless tales, add your own favorite books, and curate a collection that reflects your unique literary journey. In a world that moves fast, The Book Haven invites you to slow down, sip your coffee, and lose yourself between the lines — because every great story deserves a home.</p>
                </div>

                <hr data-aos="fade-bottom-left" className=" hidden lg:flex border text-accent"/>
                <hr data-aos="fade-up-left" className="border hidden lg:flex text-accent"/>
                
                <div data-aos="fade-right" className="hidden lg:block py-5 lg:py-10  border-r-4 border-r-accent md:px-4">
                    <h1 data-aos="fade-up" className="text-2xl text-right font-bold text-accent pt-5 lg:pt-10 my-3">Our Mission</h1>
                ...
                <hr data-aos="fade-left" className=" hidden lg:flex border text-accent"/>
                <hr data-aos="fade-right" className="border hidden lg:flex text-accent"/>
                

                <div data-aos="fade-left" className="hidden lg:block py-5 lg:py-10 border-l-4 border-l-accent md:px-4">
                    <h1 data-aos="fade-bottom" className="text-2xl text-left font-bold text-accent pt-10 lg:pt-20 my-3">
                        Our Vision
                    </h1>
