...
const About = () => {
    ...
    return (
        <div className="py-10 lg:py-20 font bg-accent-content">
            <div data-aos="fade-up" data-aos-easing="ease-in-out" className="max-w-11/12 mx-auto px-15 lg:px-30 text-primary min-h-screen border-l-accent border-l-4">
                <div data-aos="fade-right">
                    <h1 data-aos="fade-up" className="text-3xl text-center font-bold text-accent pt-10 my-3">
                        About Book Haven
                    </h1>
                ...
                <div data-aos="fade-right" className="py-5 lg:py-10">
                    <h1 data-aos="fade-up" className="text-3xl text-right font-bold text-accent pt-10 lg:pt-20 my-3">Our Mission</h1>
                ...
                <div data-aos="fade-up" className="py-5 lg:py-10">
                    <h1 data-aos="fade-down" className="text-3xl text-left font-bold text-accent pt-10 lg:pt-20 my-3">
                        Our Vision
                    </h1>
                    <p data-aos="fade-up" className="text-justify text-accent my-5 lg:my-10 pb-10">
